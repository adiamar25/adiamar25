...
def test_apply_kernel():
    ...
    assert apply_kernel([[1, 2, 3]], [[0] * 3, [0, 1, 0], [0] * 3]) == [
        [1, 2, 3]]
    # assert apply_kernel([[1, 2, 3]], [[0] * 3, [0, 0, 1], [0] * 3]) == [
    #     [2, 3, 3]]
