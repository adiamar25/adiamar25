...
typedef struct MarkovNode {
    void *data;
    NextNodeCounter *frequencies_list;
    int freq_list_len;
} MarkovNode;
...
typedef struct MarkovChain {
    ...
    // returns void.
    /* <fill_type> */ print_func_p print_func;
